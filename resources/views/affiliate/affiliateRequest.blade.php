...
<body>
    <div>
        ...
        <p>Sign up now to start earning {{$affiliate_program->commissionRate}}% commission for life and {{$affiliate_program->amountPerInstall}}$ when your referrals install the app</p>
